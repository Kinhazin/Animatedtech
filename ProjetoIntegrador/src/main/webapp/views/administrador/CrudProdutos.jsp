...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/styleCrudProdutos.css">
</head>
...
<body>
	...
	<main class="meio">
		...
		<section class="meio_tabela">
			<img class="batman"
				src="${pageContext.request.contextPath}/includes/CADASTRO-PRODUTOS_BATMAN.png"
			...
			<table class="tabela_crud">
				...
				<c:forEach var="produto" items="${listaProduto}">
					<tr>
						...
						<td class="imgs"><a href="${pageContext.request.contextPath}/produtos/editar?id=${produto.idProduto}"> <img
								src="${pageContext.request.contextPath}/includes/CRUD_LAPIS.png"
								height="25px" width="auto">
						</a> 
						<a href="${pageContext.request.contextPath}/produtos/excluir?id=${produto.idProduto}"><img
