...
import br.com.animatedtech.DAO.NotaFiscalDAO;
...
String action = request.getServletPath();
		...
		try {
			...
			case "/notafiscal/cadastro":
				RequestDispatcher dispatcher = request.getRequestDispatcher("/views/notafiscal/CadastrarNota.jsp");
			...
			default:
				RequestDispatcher dispatcher2 = request.getRequestDispatcher("/views/notafiscal/CadastrarNota.jsp");
	...
	public void novo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        int numeroNota = notaFiscalDAO.salvar(idCliente ,dataNota, vetorIdProdutos, vetorQtdProdutos, vetorValoresUnitarios);
        ...
        request.getRequestDispatcher("/views/notafiscal/CadastrarNota.jsp").forward(request, response);
